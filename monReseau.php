    ...
    <div id="contacts">
        ...
        <div id="contacts-list">
            <?php while ($user = $recupUser->fetch()) { ?>
                <p>
                    <?php echo $user['nom']; echo " "; echo $user['prenom']; echo " : "; echo $user['email']; ?>
...
<section id="demandes-amis">
    ...
    while ($demande = $recupDemandes->fetch()) {
        ?>
        <div class="demande">
            <p><?php echo $demande['nom']; echo " "; echo $demande['prenom']; ?> souhaite devenir votre ami(e).</p>
...
<section id="liste-amis">
    ...
    while ($ami = $recupAmis->fetch()) {
        ?>
        <p><?php echo $ami['nom']; echo " "; echo $ami['prenom']; ?></p>
        <?php
    }
    ?>
</section>
